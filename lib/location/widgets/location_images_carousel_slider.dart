...
// class LocationImagesCarouselSlider extends StatelessWidget {
//   const LocationImagesCarouselSlider({
//   super.key,
...
//       category: ca
//     )..fetchLocations(categoryId: categoryId, ranking: ranking, limit: 6),
//     child: _Content(),
//   );
// }
//
...
//         builder: (context, state) => SingleChildScrollView(child:Column(
//           children: [
//             CarouselSlider(
